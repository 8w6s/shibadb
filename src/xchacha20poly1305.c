...
)
{
    ...
    /*
     * Propagate the setup return instead of discarding it — key/nonce are
     * already validated by the entry-point NULL check above, but a future
     * refactor that skips that guard would silently corrupt subkey/nonce.
     */
    {
