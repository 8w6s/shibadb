...
#define SDB_SUPERBLOCK_CHECKSUM_SIZE ((size_t)4)

_Static_assert(
    SDB_SUPERBLOCK_CHECKSUM_OFFSET + SDB_SUPERBLOCK_CHECKSUM_SIZE
        <= SDB_SUPERBLOCK_HEADER_SIZE,
    "superblock checksum field lies outside the header"
);
