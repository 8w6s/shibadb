#!/usr/bin/env python3
"""Create and validate machine-readable GitHub Actions release evidence."""
...
def validate_ci_evidence(
    ...
    *,
    ...
    """Validate CI evidence and return a stable reason on failure."""
...
def validate_security_audit_evidence(
    ...
    """Validate evidence supplied by an independent security reviewer."""
    if not isinstance(data, dict):
        return False, "evidence must be a JSON object"
