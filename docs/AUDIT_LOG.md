...
Log of independent security review passes. Each entry records the
baseline and head commits at the time of the pass, the findings, and
the follow-up commits that closed them.
